...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        with open("nameslist.txt", "r") as f:
            ...
            for i in z:
                names.add(i)
        self.title_font = tkfont.Font(family='Cambria', size=16, weight="bold")
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            button1 = tk.Button(self, text="   Add new User  ", fg="#260f33", bg="#ffffff",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="   Take Attendance  ", fg="#260f33", bg="#ffffff",command=lambda: self.controller.show_frame("PageTwo"))
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="What's the name : ", fg="#263942", font='Cambria 12 bold').grid(row=0, column=0, pady=10, padx=5)
        self.user_name = tk.Entry(self, borderwidth=3, bg="lightgrey", font='Cambria 11')
    ...
    def start_training(self):
        ...
        if self.user_name.get() == "None":
            ...
            messagebox.showerror("Error", "User with this name already exist :( ")
            return
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        global names
        self.controller = controller
        tk.Label(self, text="Select user", fg="#263942", font='Cambria 12 bold').grid(row=0, column=0, padx=10, pady=10)
        ...
        self.buttonext = tk.Button(self, text="Next", command=self.nextfoo, fg="#263942", bg="#ffffff")
...
class PageThree(tk.Frame):
    ...
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        self.numimglabel = tk.Label(self, text = "Count of Image Captured : 0", font='Cambria 12 bold', fg="#263942")
    ...
    def trainmodel(self):
        if self.controller.num_of_images < 300:
            messagebox.showerror("Error", "Not enough space to capture 300 images")
            return
        train_classifer(self.controller.active_name)
        messagebox.showinfo("Success", "All image captured and madel has been trained")
        self.controller.show_frame("PageFour")
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Face Recognition", font='Cambria 16 bold')
        label.grid(row=0,column=0, sticky="ew")
        button1 = tk.Button(self, text="Face Recognition", command=self.openwebcam, fg="#263942", bg="#ffffff")
        #button2 = tk.Button(self, text="Emotion Detection", command=self.emot, fg="#263942", bg="#ffffff")
        #button3 = tk.Button(self, text="Gender and Age Prediction", command=self.gender_age_pred, fg="#263942", bg="#ffffff")
